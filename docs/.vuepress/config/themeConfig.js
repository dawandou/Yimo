...
module.exports = {
  ...
  logo: '/img/YiMo-logo.gif', // 导航栏logo
  repo: 'dawandou/', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'YiMO.一茉', // 必需
    link: 'https://github.com/dawandou', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: '/img/YiMo-logo.gif',
    name: 'YiMO.一茉',
    slogan: '拥抱生活，追寻真实的快乐',
  },
  social: {
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:2390472338@qq.com',
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/dawandou',
      },
      {
        iconClass: 'icon-csdn',
        title: 'CSDN',
        link: 'https://blog.csdn.net/m0_37779600',
      },
    ],
  },
  footer: {
